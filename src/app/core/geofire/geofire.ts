...
export const GeoFire = (function() {
        ...
        this.set = function(keyOrLocations, location) {
            ...
            Object.keys(locations).forEach(function(key) {
                ...
                if (location === null) {
                    ...
                    var geohash = encodeGeohash(location, undefined);
     ...
     */
    (GeoFire as any).distance = function(location1, location2) {
...
// Cutoff for rounding errors on double calculations
    ...
    function decodeGeoFireObject(geoFireObj) {
        if (geoFireObj !== null && geoFireObj.hasOwnProperty("l") && Array.isArray(geoFireObj.l) && geoFireObj.l.length === 4) {
            return geoFireObj.l;
        } else {
    ...
    var GeoQuery = function (firebaseRef, queryCriteria) {
        ...
        function _updateLocation(key, location) {
            ...
            distanceFromCenter = (GeoFire as any).distance(location, _center);
        ...
        function _removeLocation(key, currentLocation) {
            ...
            if (typeof locationDict !== "undefined" && locationDict.isInQuery) {
                var distanceFromCenter = (currentLocation) ? (GeoFire as any).distance(currentLocation, _center) : null;
        ...
        function _childRemovedCallback(locationDataSnapshot) {
            ...
            if (_locationsTracked.hasOwnProperty(key)) {
                _firebaseRef.child(key).once("value", function(snapshot) {
                    ...
                    var geohash = (location !== null) ? encodeGeohash(location, undefined) : null;
        ...
        function _listenForNewGeohashes() {
            ...
            if(geohashesToQuery.length === 0) {
                _geohashQueryReadyCallback(undefined);
            }
        }
        ...
        this.updateCriteria = function(newQueryCriteria) {
            ...
            validateCriteria(newQueryCriteria, undefined);
            ...
            for (var i = 0; i < numKeys; ++i) {
                ...
                locationDict.distanceFromCenter = (GeoFire as any).distance(locationDict.location, _center);
